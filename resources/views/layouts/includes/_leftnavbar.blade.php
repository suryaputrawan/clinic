      ...
      <ul class="nav navbar-nav">
        ...
        <li class="menu-item-has-children dropdown">
            ...
            <ul class="sub-menu children dropdown-menu">
              ...
              <li><i class="menu-icon fa fa-file-text-o"></i><a href="{{ route('serology') }}">Serology Test</a></li>
            </ul>
        </li>
        <li class="menu-item-has-children dropdown">
          ...
          <ul class="sub-menu children dropdown-menu">
            ...
            <li><i class="menu-icon fa fa-user-md"></i><a href="{{ route('labstaff') }}">Staff Lab</a></li>
