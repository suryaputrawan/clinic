      ...
      <div class="card-body card-block">
        <form action="{{ route('antigen.update', $antigen->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9"><input type="text" id="nrm" name="patient_patNRM" placeholder="NRM" class="form-control @error('patient_patNRM') is-invalid @enderror" value="{{ old('patient_patNRM', $antigen->patient_patNRM) }}" autocomplete="off">
