    ...
    <div id=halaman><br><br><br>
        ...
        <table>
            ...
            <tr>
              ...
              <td style="width: 5%;">:</td>
              <td style="width: 65%;">{{ $rapid->pob }}, {{ $newformat }}</td>
            </tr>
            <tr>
        ...
        <table style="border-collapse: collapse" border="3" width="650px">
          ...
          <tbody>
            <tr>
              <td style="border: 1px solid black"><center>{{ $tanggal }}</center></td>
              <td style="border: 1px solid black"><center>IgG/IgM Antibody SARS-COV-2 Rapid Test</center></td>
              <td style="border: 1px solid black"><center>{{ $rapid->result }}</center></td>
            </tr>
          </tbody>
        </table>
