        ...
        <div class="card-body card-block">
          <form action="{{ route('lab.update', $laboratorium->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-9"><input type="text" id="name" name="name" placeholder="Nama Lab" class="form-control @error('name') is-invalid @enderror" value="{{ $laboratorium->name }}" autocomplete="off"></div>
              @error('name')
