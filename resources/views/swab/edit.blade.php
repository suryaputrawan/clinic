      ...
      <div class="card-body card-block">
        <form action="{{ route('swabtest.update', $swabtest->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-9"><input type="text" id="nrm" name="patient_patNRM" placeholder="NRM" class="form-control @error('patient_patNRM') is-invalid @enderror" value="{{ old('patient_patNRM', $swabtest->patient_patNRM) }}" autocomplete="off">
