    ...
    <!-- End Flass Message -->
      <div class="card">
        <div class="card-header">
          <div class="pull-left">
            <strong>Form Input Data</strong> Plebotomis
          </div>
        ...
        <div class="card-body card-block">
          <form action="{{ route('plebotomis.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
            @csrf
